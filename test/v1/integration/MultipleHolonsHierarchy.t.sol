...
//             address[] memory _members = zoned.getZoneMembers(zone);
//             if (_members.length > 0) {
//                 console.log("_members in Zone", zone, ":");
//                 for (uint i = 0; i < _members.length; i++) {
//                     console.log("  Member", i, ":", _members[i]);
//                 }
//             } else {
//                 console.log("Zone", zone, "has no _members.");
//             }
//         }
//         // Temporarily
//         vm.prank(deployer);
